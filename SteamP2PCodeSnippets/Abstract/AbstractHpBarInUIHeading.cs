...
public class AbstractHpBarInUIHeading : AbstractHpBar {
    ...
    public AbstractHpBarInUIHeading() {
        ...
        hpInterpolaterSpeed = hpSizeXFillPerSecond / (PbPrimitivesOverride.BATTLE_DYNAMICS_FPS); // per frame 
    }
	...
	public virtual void SetCharacter(CharacterDownsync chd) {
		...
		var newChConfig = PbCharactersOverride.Instance.getUnderlying()[chd.SpeciesId];
