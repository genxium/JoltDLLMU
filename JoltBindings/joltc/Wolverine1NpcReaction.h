#ifndef WOLVERINE1_NPC_REACTION_H_
#define WOLVERINE1_NPC_REACTION_H_ 1
...
class Wolverine1NpcReaction : public BaseNpcReaction {
public:
    Wolverine1NpcReaction() : BaseNpcReaction() {
