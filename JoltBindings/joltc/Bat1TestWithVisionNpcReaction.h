#ifndef BAT1_TEST_WITH_VISION_NPC_REACTION_H_
#define BAT1_TEST_WITH_VISION_NPC_REACTION_H_ 1
...
class Bat1TestWithVisionNpcReaction : public BaseNpcReaction {
public:
    Bat1TestWithVisionNpcReaction() : BaseNpcReaction() {
