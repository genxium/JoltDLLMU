...
public:
    ...
    virtual RenderFrame* SingleStep(int currRdfId, int delayedIfdId, InputFrameDownsync* delayedIfd);
    virtual bool WriteSingleStepFrameLog(int currRdfId, RenderFrame* nextRdf, int fromRdfId, int toRdfId, int delayedIfdId, InputFrameDownsync* delayedIfd);
