...
namespace JoltCSharp {
    public class PbCharacters {
        ...
        public PbCharacters(PrimitiveConsts primitiveConsts) {
        ...
        protected virtual bool lazyInit() {
            ...
            underlying = new MapField<uint, CharacterConfig>() { };
         ...
         ``` 
         */
            CharacterConfig BLADEGIRL = new CharacterConfig {
            ...
            CharacterConfig HEADQUARTER1 = new CharacterConfig {
                SpeciesId = SPECIES_HEADQUARTER1,
                SpeciesName = "HeadQuarter1",
                Hp = 1000,
                Mp = 0,
                ...
                AccMagX = 0,
                AngYSpeed = 0,
                HasVisionReaction = false,
                CapsuleRadius = (24.0f),
                CapsuleHalfHeight = (32.0f),
                ShrinkedCapsuleRadius = (24.0f),
                ShrinkedCapsuleHalfHeight = (32.0f),
                LayDownCapsuleRadius = (24.0f),
                LayDownCapsuleHalfHeight = (32.0f),
                DyingCapsuleRadius = (24.0f),
                DyingCapsuleHalfHeight = (32.0f),
                HasTurnAroundAnim = false,
                Hardness = 1000,
                ColliderDensity = 128.0f,
                HasDimmedAnim = false,
                MinFallingVelY = DEFAULT_MIN_FALLING_VEL_Y * BATTLE_DYNAMICS_FPS,
            ...
            CharacterConfig SHIELDGUARD1 = new CharacterConfig {
                SpeciesId = SPECIES_SHIELDGUARD1,
                SpeciesName = "ShieldGuard1",
                Hp = 50,
                Mp = 0,
                MpRegenPerInterval = 0,
                MpRegenInterval = 0,
                ...
                HasDef1 = true,
                DefaultDef1Quota = 5,
                DefaultDef1BrokenFramesToRecover = 50,
                Def1StartupFrames = 3,
            ...
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownB, false, true, false, false, false, false, false, false), BladeGirlCrouchSlashId);

            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternE, false, false, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternE, false, false, false, false, true, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontE, false, false, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontE, false, false, false, false, true, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, false, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, false, false, false, true, false, false, false), BladeGirlSlidingId);

            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternE, false, true, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternE, false, true, false, false, true, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontE, false, true, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontE, false, true, false, false, true, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, true, false, false, false, false, false, false), BladeGirlSlidingId);
            BLADEGIRL.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, true, false, false, true, false, false, false), BladeGirlSlidingId);
            ...
            // BOUNTY_HUNTER
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, false, false, false, false, false, false, false), HunterPistolId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, false, false, false, true, false, false, false), HunterPistolWalkingId);

            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, true, false, false, false, false, false, false, false), HunterPistolAirId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, true, false, true, false, false, false, false, false), HunterPistolWallId);

            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, true, false, false, false, false, false, false), HunterPistolCrouchId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownB, false, false, false, false, false, false, false, false), HunterPistolCrouchId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownB, false, true, false, false, false, false, false, false), HunterPistolCrouchId);

            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternReleasedB, false, false, false, false, false, false, false, false), HunterChargedPistolId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternReleasedB, false, false, false, false, true, false, false, false), HunterChargedPistolWalkingId);

            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternReleasedB, true, false, false, false, false, false, false, false), HunterChargedPistolAirId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternReleasedB, true, false, true, false, false, false, false, false), HunterChargedPistolWallId);

            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternReleasedB, false, true, false, false, false, false, false, false), HunterChargedPistolCrouchId);
            ...
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontEHoldB, false, false, false, false, true, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, false, false, false, false, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, false, false, false, true, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownEHoldB, false, false, false, false, false, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownEHoldB, false, false, false, false, true, false, false, false), HunterSlidingId);
            ...
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternFrontEHoldB, false, true, false, false, true, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, true, false, false, false, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownE, false, true, false, false, true, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownEHoldB, false, true, false, false, false, false, false, false), HunterSlidingId);
            BOUNTY_HUNTER.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternDownEHoldB, false, true, false, false, true, false, false, false), HunterSlidingId);
            underlying.Add(BOUNTY_HUNTER.SpeciesId, BOUNTY_HUNTER);

            // BLACKSABER1
            BLACKSABER1.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, false, false, false, false, false, false, false), BlackSaber1GroundSlash1Id);
            BLACKSABER1.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, false, false, false, true, false, false, false), BlackSaber1GroundSlash1Id);
            ...
            BLACKTHROWER1.InitSkillTransit.Add(EncodePatternForInitSkill(primitiveConsts.PatternB, false, false, false, false, true, false, false, false), BlackThrower1TimedBombId);
        ...
        public MapField<uint, CharacterConfig> getUnderlying() {
            if (!lazyInit() || null == underlying) {
                throw new ArgumentNullException("Failed to initialize the underlying of PbCharacters");
            }
            return underlying;
        }
    }
